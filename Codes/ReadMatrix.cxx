...
TH1F* projectionToMatrixX(TH2F *matrix,Float_t gate1, Float_t gate2){
  ...
  Int_t bin1=matrix->GetYaxis()->FindBin(gate1_D);
  Int_t bin2=matrix->GetYaxis()->FindBin(gate2_D);
  cout<<"Bin1:"<< bin1<<"\n";
  cout<<"Bin2:"<< bin2<<"\n";
  cout<<"Gate1:"<<gate1_D<<"\n";
  cout<<"Gate2:"<<gate2_D<<"\n";
...
void ReadMatrix::createHistogram(TH2F *matrix, TString axis, TString gate1Text,TString gate2Text,TString background1Text,TString background2Text,TString background3Text,TString background4Text){
  TString title;
  TString number;
  Double_t factor1;
  Double_t factor2;
